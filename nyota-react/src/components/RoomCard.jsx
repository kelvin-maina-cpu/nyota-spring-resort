      ...
      <div className="space-y-4 p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 font-sans-body text-sm text-stone-500 dark:text-stone-400">{room.guests}</p>
          </div>
          <span className="font-sans-body text-sm font-semibold text-nyota-bronze">{room.price}</span>
        </div>
        <p className="font-sans-body text-sm leading-7 text-stone-600 dark:text-stone-300">{room.description}</p>
        <button
          type="button"
